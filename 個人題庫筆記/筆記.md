題目注意:  
123很長 
153學看ipconfig表  154 ,194,197,199(注意雖然我對),206有點問題,236,253,261,267計算,269,274,366,388,530dhcp解釋, 565,650    
+ NAT是將內部ip轉成外部
+ SOHO network :    
...
## HSRP  
HSRP主要是layer3 default gateway的備援在**virtual router**   
...
+ marking: cahnge the value of the TOS field in the IPv4 packet header  
...
---->可以DTP關閉,nonegotiate,port shut down ,直接設定trunk`switch port mode`,所有port指定到某vlan不要用native vlan      
